...
* SAS 70 - **outdated like the 70s** SSAE SOC 18
* SOC 16 - outdated SOC 18
...
* CSA Cloud Controls Matrix (CCMv4) - Cloud Risk Management framework by CSA, mapped to trusted organizations&frameworks like ISO, ISACA, PCI. **CSA's best child**
